...
if (!createObject('modNamespace',array(
    'name' => 'commerce_notifystock',
    'path' => $componentPath.'/core/components/commerce_notifystock/',
    'assets_path' => $componentPath.'/assets/components/commerce_notifystock/',
),'name', false)) {
    echo "Error creating namespace commerce_notifystock.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_notifystock.core_path',
    'value' => $componentPath.'/core/components/commerce_notifystock/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_notifystock',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_notifystock.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_notifystock.assets_path',
    'value' => $componentPath.'/assets/components/commerce_notifystock/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_notifystock',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_notifystock.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_notifystock/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_notifystock.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_notifystock',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_notifystock.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_notifystock.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_notifystock/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_notifystock/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\NotifyStock\\Modules\\', $modulePath);

$manager = $modx->getManager();

$modx->addPackage('commerce_notifystock', $componentPath . '/core/components/commerce_notifystock/model/');

$manager->createObjectContainer('NotifyStockMessage');
$manager->createObjectContainer('NotifyStockRequest');
